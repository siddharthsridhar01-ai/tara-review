...
const vocabDefs = {
  "moral judgements": "Evaluations or opinions about whether something is right or wrong, good or bad, from an ethical standpoint.",
  "intention": "The aim or plan behind an action. What someone meant to do, as opposed to what actually happened.",
  "outcome": "The result or consequence of an action. What actually ends up happening.",
  "pedestrian": "A person walking on or near a road, as opposed to someone travelling in a vehicle.",
  "mere luck": "Pure chance or fortune, with no skill or deliberate action involved. 'Mere' emphasises that it is nothing more than luck.",
};

const phrases = [
  { id: "p1", text: "If someone tries to rescue someone from a burning roof, slips, drops them, and they die, we don't class them as a murderer.", isConclusion: false },
  { id: "p2", text: "This is because we believe that judgements should be based on the intention behind an action, not the outcome.", isConclusion: false },
  { id: "p3", text: "Whether or not we like to admit it, however, our moral judgements are sometimes shaped by mere luck.", isConclusion: true },
  { id: "p4", text: "Imagine someone gets into a car while drunk and drives home. We all agree that's bad.", isConclusion: false },
  { id: "p5", text: "Now imagine another person who does the same, but this person kills a pedestrian. We naturally think that this action is worse.", isConclusion: false },
  { id: "p6", text: "But surely the only difference is that the first driver got lucky, while the second driver was unlucky.", isConclusion: false },
  { id: "p7", text: "The second driver did not intend to kill a pedestrian any more than the first did.", isConclusion: false },
];

const roleClassifications = [
  { id: "p1", text: "If someone tries to rescue someone from a burning roof, slips, drops them, and they die, we don't class them as a murderer.", role: "background", roleLabel: "BACKGROUND CONTEXT", roleColor: C.ctx, roleBg: C.ctxBg, explanation: "This is an introductory example that sets up the general topic of how we judge actions. It illustrates a widely held view but doesn't directly prove the main conclusion about luck influencing moral judgements." },
  { id: "p2", text: "This is because we believe that judgements should be based on the intention behind an action, not the outcome.", role: "background", roleLabel: "BACKGROUND CONTEXT", roleColor: C.ctx, roleBg: C.ctxBg, explanation: "This explains the principle behind the rescue example. It describes what we believe about moral judgements, setting up the contrast with what we actually do. It frames the argument but doesn't directly prove the conclusion." },
  { id: "p4", text: "Imagine someone gets into a car while drunk and drives home. We all agree that's bad.", role: "evidence", roleLabel: "SUPPORTING EVIDENCE", roleColor: C.prem, roleBg: C.premBg, explanation: "This is the first part of the drunk driver thought experiment. It establishes a baseline scenario that the author uses as evidence to demonstrate how luck shapes our judgements." },
  { id: "p5", text: "Now imagine another person who does the same, but this person kills a pedestrian. We naturally think that this action is worse.", role: "evidence", roleLabel: "SUPPORTING EVIDENCE", roleColor: C.prem, roleBg: C.premBg, explanation: "This is the second part of the thought experiment. By showing that we judge the unlucky driver more harshly, the author provides direct evidence that luck influences our moral judgements." },
  { id: "p6", text: "But surely the only difference is that the first driver got lucky, while the second driver was unlucky.", role: "evidence", roleLabel: "SUPPORTING EVIDENCE", roleColor: C.prem, roleBg: C.premBg, explanation: "This draws out the implication of the thought experiment. The author points out that the only variable between the two scenarios is luck, which directly supports the conclusion that luck shapes our moral judgements." },
  { id: "p7", text: "The second driver did not intend to kill a pedestrian any more than the first did.", role: "evidence", roleLabel: "SUPPORTING EVIDENCE", roleColor: C.prem, roleBg: C.premBg, explanation: "This reinforces the previous point by emphasising that intention was identical in both cases. If intention is the same but our judgement differs, the difference must come from luck. This directly supports the main conclusion." },
];
...
const opts = [
  { letter: "A", text: "If someone accidentally kills someone while trying to rescue them we don't consider them a murderer.", ok: false,
    roleTag: "BACKGROUND CONTEXT", roleColor: C.ctx,
    expl: "As you classified in Step 2, this is background context. It's an introductory example used to set up the topic of moral judgement. The main conclusion is the broader claim about luck, not this specific illustration." },
  { letter: "B", text: "We believe that judgements about the morality of an action should be based on the intention behind it.", ok: false,
    roleTag: "BACKGROUND CONTEXT", roleColor: C.ctx,
    expl: "As you classified in Step 2, this is background context. It describes what we believe about how moral judgements should work. The author's main point is actually about how our judgements sometimes deviate from this belief, because of luck." },
  { letter: "C", text: "Despite what we may like to think, our moral judgements can be influenced by luck.", ok: true,
    roleTag: "MAIN CONCLUSION", roleColor: C.concl,
    expl: "This directly paraphrases the main conclusion. The entire passage builds towards this claim: the rescue example and the intention principle set the scene, and the drunk driver thought experiment proves that luck does influence our moral judgements, even though we believe it shouldn't." },
  { letter: "D", text: "The only difference between the two drivers is that the first driver got lucky.", ok: false,
    roleTag: "SUPPORTING EVIDENCE", roleColor: C.prem,
    expl: "As you classified in Step 2, this is supporting evidence. It's a key observation from the thought experiment, but it serves to prove the broader point about luck and moral judgements. It's not the main conclusion itself." },
  { letter: "E", text: "The second driver did not intend to kill someone any more than the first did.", ok: false,
    roleTag: "SUPPORTING EVIDENCE", roleColor: C.prem,
    expl: "As you classified in Step 2, this is supporting evidence. It reinforces that intention was identical in both cases, which helps prove that the difference in judgement comes from luck. But it supports the main conclusion rather than being the main conclusion." },
];
...
function PassageRaw() {
  return (
    <div style={{ fontSize: 15.5, lineHeight: 2, color: C.text }}>
      <p style={{ margin: 0 }}>If someone tries to rescue someone from a burning roof, slips, drops them, and they die, we don't class them as a murderer. This is because we believe that judgements should be based on the <Vocab term="intention">intention</Vocab> behind an action, not the <Vocab term="outcome">outcome</Vocab>. Whether or not we like to admit it, however, our <Vocab term="moral judgements">moral judgements</Vocab> are sometimes shaped by <Vocab term="mere luck">mere luck</Vocab>. Imagine someone gets into a car while drunk and drives home. We all agree that's bad. Now imagine another person who does the same, but this person kills a <Vocab term="pedestrian">pedestrian</Vocab>. We naturally think that this action is worse. But surely the only difference is that the first driver got lucky, while the second driver was unlucky. The second driver did not intend to kill a pedestrian any more than the first did.</p>
    </div>
  );
}
...
function PassageWithRoles({ roles }) {
  ...
  const sentences = [
    { id: "p1", text: "If someone tries to rescue someone from a burning roof, slips, drops them, and they die, we don't class them as a murderer." },
    { id: "p2", text: " This is because we believe that judgements should be based on the intention behind an action, not the outcome." },
    { id: "p3", text: " Whether or not we like to admit it, however, our moral judgements are sometimes shaped by mere luck." },
    { id: "p4", text: " Imagine someone gets into a car while drunk and drives home. We all agree that's bad." },
    { id: "p5", text: " Now imagine another person who does the same, but this person kills a pedestrian. We naturally think that this action is worse." },
    { id: "p6", text: " But surely the only difference is that the first driver got lucky, while the second driver was unlucky." },
    { id: "p7", text: " The second driver did not intend to kill a pedestrian any more than the first did." },
  ];
  return (
    <div style={{ fontSize: 15.5, lineHeight: 2, color: C.text }}>
...
function PassageAnnotated() {
  return (
    <div style={{ fontSize: 15.5, lineHeight: 2, color: C.text }}>
      <p style={{ margin: 0 }}>
        <span style={{ color: C.ctx, backgroundColor: C.ctxBg, padding: "2px 4px", borderRadius: 3, borderBottom: `2px solid ${C.ctx}` }}>If someone tries to rescue someone from a burning roof, slips, drops them, and they die, we don't class them as a murderer. This is because we believe that judgements should be based on the intention behind an action, not the outcome.</span>
        {" "}
        <span style={{ color: C.concl, backgroundColor: C.conclBg, padding: "2px 4px", borderRadius: 3, borderBottom: `2px solid ${C.concl}` }}>Whether or not we like to admit it, however, our moral judgements are sometimes shaped by mere luck.</span>
        {" "}
        <span style={{ color: C.prem, backgroundColor: C.premBg, padding: "2px 4px", borderRadius: 3, borderBottom: `2px solid ${C.prem}` }}>Imagine someone gets into a car while drunk and drives home. We all agree that's bad. Now imagine another person who does the same, but this person kills a pedestrian. We naturally think that this action is worse. But surely the only difference is that the first driver got lucky, while the second driver was unlucky. The second driver did not intend to kill a pedestrian any more than the first did.</span>
      </p>
    </div>
  );
}
  ...
  return (
    <div>
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "16px 24px", marginBottom: 18 }}>
        ...
        <div style={{ background: C.conclBg, border: `1px solid ${C.concl}`, borderRadius: 10, padding: "14px 18px", fontSize: 13, color: C.concl, lineHeight: 1.6 }}><strong>Hint:</strong> The passage opens with an example and a principle, then introduces a contrasting idea. Look for the sentence that uses a signal word like "however" to pivot towards the author's own central claim.</div>
      </div>
          ...
          <div style={{ background: found ? `${C.concl}0a` : C.failBg, border: `1px solid ${found ? C.concl + "44" : C.fail + "44"}`, borderRadius: 10, padding: "12px 16px", marginTop: 4 }}>
            {found ? (
              <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                ...
                <p style={{ margin: 0, fontSize: 13.5, color: C.text, lineHeight: 1.65 }}><strong style={{ color: C.ok }}>Correct!</strong> The word "however" signals a contrast with the previous idea about intention. "Whether or not we like to admit it" tells us the author is making a claim that challenges our assumptions. The drunk driver thought experiment that follows exists to prove this one central point.</p>
              </div>
            ) : (<p style={{ margin: 0, fontSize: 13, color: C.white }}>Try again. This sentence provides a specific detail, example, or supporting point. Ask yourself: is this the broadest claim in the passage, or does it serve to support or illustrate a bigger point?</p>)}
          </div>
        )}
      </div>
    </div>
    ...
    <div>
      <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "16px 24px", marginBottom: 18 }}>
        ...
        <div style={{ background: "#1e2030", border: `1px solid ${C.border}`, borderRadius: 10, padding: "14px 18px", fontSize: 13, color: C.text, lineHeight: 1.8 }}>
          <p style={{ margin: "0 0 6px" }}><strong style={{ color: C.ctx }}>Background context</strong>: sets the scene, provides an introductory example, or frames the topic. Doesn't directly prove the conclusion.</p>
            ...
            <div key={s.id} style={{ background: C.card, border: `1.5px solid ${bc}`, borderRadius: 14, padding: "16px 20px", transition: "all 0.3s" }}>
              ...
              {isWrong && !isCorrect && (
                <div style={{ background: C.failBg, border: `1px solid ${C.fail}44`, borderRadius: 10, padding: "10px 14px" }}>
                  <p style={{ margin: 0, fontSize: 13, color: C.white, lineHeight: 1.6 }}>Try again. Ask yourself: does this phrase set the scene or introduce the topic? Or does it provide a specific reason, example, or observation that directly proves the conclusion about luck shaping moral judgements?</p>
                </div>
              )}
            </div>
          );
    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "'Gill Sans', 'Trebuchet MS', Calibri, sans-serif", letterSpacing: 0.2, padding: "24px 16px" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: C.muted, margin: 0 }}>TSA 2022 · Question 39</p>
        </div>
        ...
        {step === 3 && (
          <>
            ...
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 14, padding: "22px 24px", marginBottom: 18 }}><span style={{ fontSize: 11, fontWeight: 600, color: C.muted, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 14 }}>Passage</span><PassageAnnotated /><div style={{ marginTop: 12, display: "flex", gap: 10, flexWrap: "wrap", fontSize: 11, color: C.muted }}><span><span style={{ color: C.concl }}>■</span> Conclusion</span><span><span style={{ color: C.ctx }}>■</span> Background</span><span><span style={{ color: C.prem }}>■</span> Evidence</span></div></div>
